...
class QuestionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let questions = [
            ...
            ["q":"Amas de cada Arequipeñas compran alimentos con mayor frecuencia que las amas de casa trujillanas?","a":"Según información de Kantar Worldpanel, las amas de casa arequipeñas acuden al canal 228 veces, mientras que las amas de casa trujillanas lo hacen 239 veces","validate":false],
            ...
            ["q":"¿El 5% de los hogares peruanos hacen compras de productos masivos online?","a":"Según información de Kantar Worldpanel  solo el 1% de los hogares peruanos hacen compras de productos de consumo masivo para el  hogar por internet, principalmente no compran porque muchos no saben cómo hacerlo, tiene desconfianza del uso de la tarjeta o porque no posee internet.","validate":false],
            ["q":"¿Amas de casa peruanas les gusta ir de compras así no tenga una necesidad real?","a":"Según información de Kantar Worldpanel para el 65% de las amas de casa, ir de compras es una necesidad, van solo cuando requieren de algo.","validate":false],
            ...
            ["q":"Cuando nuestras encuestadoras visitan a nuestras panelista. ¿Registra sus compras en un diario de compras?","a":"Según metodología de Kantar Worldpanel en Peru, la encuestadora registra las compras bajo la metodología de recolección “SCANNING”. La cual consiste en escanear los códigos de barra de cada producto y registrar todas las compras en un smarthphone.","validate":false],
